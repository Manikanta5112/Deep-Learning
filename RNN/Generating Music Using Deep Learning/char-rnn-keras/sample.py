...
def sample(epoch, header, num_chars):
    ...
    for i in range(num_chars):
        ...
        # here the resul is vector of 86Dim    
        result = model.predict_on_batch(batch).ravel()
        # from this vector I am sampling one char based on the probability
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', default='', help='initial (intial character input to a RNN) seed for the generated text')
